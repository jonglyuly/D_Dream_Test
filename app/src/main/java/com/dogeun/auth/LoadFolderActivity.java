...
public class LoadFolderActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_load_folder);

        //TTS 객체 초기화
        ttsModule = new TTSModule(LoadFolderActivity.this);
        ...
        select_button.setOnClickListener(new Button.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(LoadFolderActivity.this, LoadFileActivity.class);
